  ...
  return (
    <main className="legal-page">
      ...
      <p>
        ...
        personal data we collect when you visit blindsight.io, how we use it, and your rights under
        applicable law. It applies under the Swiss Federal Act on Data Protection (nDSG / revFADP)
      ...
      <p>
        ...
        <br />
        Contact: <a href="mailto:info@blindsight.io">info@blindsight.io</a>. Full company details:{" "}
        <Link to="/imprint">Imprint</Link>.
      </p>

      <h2>2. Data we collect</h2>
      <p>
        <strong>Forms.</strong> When you submit a contact, demo request, or careers form, we collect
        the information you provide: typically your name, work email address, message, and (for
        applications) any CV or covering note. We use this only to respond to you, arrange a demo,
        or evaluate your application.
      </p>
      <p>
      ...
      <p>
        ...
        basic site functionality. We do not use analytics, advertising, or any third-party tracking
        technologies.
      </p>
      ...
      <p>
        We use the following providers to operate this site, each acting as a data processor on our
        behalf:
      </p>
      <ul
        style={{
      ...
      >
        ...
        <li>
          <strong>Microsoft Ireland Operations Limited</strong> (Ireland): the Microsoft 365 mailbox
          where form submissions are delivered, with EU data residency.
        </li>
      </ul>
      <p>
      ...
      <p>
        Some of your personal data is transferred to the United States through our use of Bluehost
        and Resend. These transfers are covered by the European Commission's Standard Contractual
        Clauses (SCCs), as recognised under Swiss law, and where applicable by the EU–U.S. Data
        Privacy Framework and its Swiss extension. The remainder of your data is stored and
        processed within Switzerland and the European Economic Area.
      </p>

      <h2>6. Legal basis</h2>
      <p>
        We rely on legitimate interest (GDPR Art. 6(1)(f); equivalent under nDSG) for responding to
        enquiries and operating the site, and on pre-contractual steps (Art. 6(1)(b)) for processing
        job applications.
      </p>

      <h2>7. Your rights</h2>
      <p>
        You can request access, correction, erasure, restriction, objection, portability (GDPR), or
        withdrawal of consent at any time by emailing{" "}
      ...
      <h2>9. Changes</h2>
      <p>
        We may update this notice to reflect changes in our practices or applicable law. The current
