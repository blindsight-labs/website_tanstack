...
import { MetalDefs, type Theme } from "@/mockups/8/shared";
import { Nav } from "@/mockups/8/Nav";
import { Hero } from "@/mockups/8/Hero";
import { ProofStrip } from "@/mockups/8/ProofStrip";
import { Risks } from "@/mockups/8/Risks";
import { Sequence } from "@/mockups/8/Sequence";
import { Walkthrough } from "@/mockups/8/Walkthrough";
import { Deployment } from "@/mockups/8/Deployment";
import { Discovery } from "@/mockups/8/Discovery";
import { Why } from "@/mockups/8/Why";
import { Faq } from "@/mockups/8/Faq";
import { FinalCta } from "@/mockups/8/FinalCta";
import { Footer } from "@/mockups/8/Footer";

import systemCss from "@/mockups/8/system.css?url";
import heroCss from "@/mockups/8/hero.css?url";
import topCss from "@/mockups/8/top.css?url";
import sequenceCss from "@/mockups/8/sequence.css?url";
import midCss from "@/mockups/8/mid.css?url";
import bottomCss from "@/mockups/8/bottom.css?url";
