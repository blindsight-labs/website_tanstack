...
import { Label, scrollProgress, type SectionProps, type Theme } from "./shared";
...
function SequenceLive({ theme }: { theme: Theme }) {
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      clamp = stage;
      live.resize(sr.width, sr.height, { x: stage.x, y: stage.y + 58, w: stage.w, h: stage.h - 116 });
      request();
    };
    ...
    import("./three/core")
      .then((core) => {
        ...
        live.render(scrollProgress(scroller));
        setReady(true);
      })
