/* Copy for mockup 5 (mockup 4 + network hero, "Govern it" replaces "Prove it"), taken from the Sep 24 website brief (@guilherme).
...
export const hero = {
  ...
  storyboard: [
    "A calm office: five workstations, a server rack running one registered agent, a database.",
    "See it: a scan passes. The rack's agent is marked registered; on two desks an AI nobody registered appears, one pulling records from the database, one sending data out of the building.",
  ...
  beatResults: ["2 unregistered AI found", "2 contained", "Policy applied · logged"],
  ...
  idle: "observing · 5 workstations · 1 rack · 1 database",
...
export const risks: { id: RiskId; title: string; scenario: string; short: string; evidence: string }[] = [
  ...
  },
  {
    ...
    evidence: "agent:finance read invoice_4471.pdf · 1 hidden instruction",
  },
  {
    id: "poisoned-source",
  ...
  },
  {
    ...
    evidence: "crm-assistant · OAuth via personal login · all records",
  },
];
