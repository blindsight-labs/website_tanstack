...
type Block = { p: string; cites?: number[] } | { caveat: string; cites?: number[] };
type Cell = string | { text: string; cite: number };
type FaqTable = {
  title: string;
  head: string[];
  rows: Cell[][];
...
type QA = { q: string; blocks: Block[] };
type Source = { n: number; text: string; url?: string };
type Theme = {
  id: string;
  label: string;
  questions: QA[];
  ...
  return (
    <section className="section" id="faq">
      <div className="section-inner faq-inner">
        ...
        <div className="faq-panel reveal" role="tabpanel">
